...
public class StudentChooser2
{
  ...
  {
    String students = "Eddy Olivia Ashmit Frank Grant";


    String studentBuilder = students;

    for (int numberOfSpaces = 0; numberOfSpaces < studentNumber - 1; numberOfSpaces++)
    {
  ...
  public static String getInput()
  {
    ...
    System.out.println("Enter an integer between 1 and 5 inclusive: ");
